...
import { getAgentPatents, getPatentByReference } from "@/lib/api";
    ...
    const loadDocuments = async () => {
      ...
      const detailed = await Promise.all(
        filings.slice(0, 30).map(async (f) => {
          ...
          if (!detailResult.ok) return f;
          return { ...f, ...detailResult.data };
        })
      );
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Files and attachments for your assigned cases.</p>
        </div>
