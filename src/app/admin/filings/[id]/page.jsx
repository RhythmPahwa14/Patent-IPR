    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm space-y-8">
        ...
        <div className="space-y-4 pt-4 border-t border-gray-100">
             <h3 className="text-[11px] font-bold tracking-widest uppercase text-gray-400 border-b border-gray-100 pb-2">Abstract / Description</h3>
             <p className="text-sm text-gray-700 whitespace-pre-wrap leading-relaxed">{filing.abstractText || "-"}</p>
        </div>

        {filing.supportingDocumentUrl && (
             <div className="pt-4 border-t border-gray-100">
                 <h3 className="text-[11px] font-bold tracking-widest uppercase text-gray-400 pb-2 mb-4">Supporting Document</h3>
                 <a href={filing.supportingDocumentUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-[#10243a] text-white rounded-lg hover:bg-[#1a3655] transition-colors text-sm font-semibold">
